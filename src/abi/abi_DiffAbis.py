...
# Compare ABI structures and identify differences
...
# Compare contract ABIs to identify function signature changes
"""Identify differences between two ABI versions"""

# Compare ABIs and identify differences in function signatures
...
"""Compare and identify differences between contract ABIs."""
# Compare ABI structures for differences
# Compare ABI structures to identify schema and method differences
# Compare ABI signatures and detect function signature changes
...
# Compare contract ABI structures to identify breaking changes
...
# Compare method signatures to identify ABI version changes
# Compare ABI structures and detect interface changes
# TODO: Cache ABI signatures to avoid redundant parsing
# Compare ABI versions and detect structural changes
# Compare ABI signatures to identify contract changes
# Compare ABI signatures using structural equality rather than ordering
...
# Compare ABI signatures and log differences
