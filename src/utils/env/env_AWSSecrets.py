"""Retrieve and manage AWS credentials and secrets from environment."""
"""
...
# AWS credentials retrieved from environment variables or IAM role
...
# Secrets are cached in memory; ensure they are not logged or exposed
